        ...
        <>
            <Carousel autoplay >
                ...
                <div className=" relative">
                    ...
                    <div className=" text-white absolute mx-auto   top-0 md:top-1/4  lg:top-1/4 xl:top-1/4 lg:bottom-1/4 left-0 md:left-10 lg:left-1/4 xl:left-1/4   p-4  bg-black opacity-75 ">
